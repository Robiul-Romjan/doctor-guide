        ...
        <div className="my-container mt-[120px]">
            <div className="grid md:grid-cols-2 relative pr-20">
                ...
                <div className="ms-auto relative">
                    ...
                    <div className="flex shadow-lg items-center justify-end rounded-[33px] p-2 w-[250px] absolute left-[-120px] bg-white top-[22%]">
                    ...
                    <div className="w-[450px] h-[646px] bg-[#0089BA] mt-[100px] rounded-l-[20px] rounded-tr-[80px] rounded-br-[20px]"></div>
                </div>
            </div>
        </div>
    );
